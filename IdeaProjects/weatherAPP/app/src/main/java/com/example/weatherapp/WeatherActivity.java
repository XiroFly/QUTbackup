...
import com.example.weatherapp.gson.ip;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        //天气统计
        Button StatisticButton = (Button)findViewById(R.id.statistics);
        StatisticButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(WeatherActivity.this, WeatherStatisticsActivity.class);
...
//                   缓存中存入数据库
                    ...
                    //存数据,主键id在sqlite里从1开始
                    List<CastsBean> casts=weather.getForecasts().get(0).getCasts();
                            ForecastsBean forecastsBean= weather.getForecasts().get(0);
                    for(CastsBean cast: casts){
                        cast.setForecastsBean(forecastsBean);
                    }
                    LitePal.saveAll(casts);
                    forecastsBean.save();
                    ...
                    List<ForecastsBean>forecastsBeans=LitePal.findAll(ForecastsBean.class);
                    List<CastsBean>castsBeans=LitePal.findAll(CastsBean.class);
                    star.getId();
    ...
    public String requestIp(){
        String ipUrl = "https://restapi.amap.com/v3/ip?key=9b55d80941361169846510880d50d21a";
...
//                            Log.d(TAG, "run: " + responseText);
                            //将查询到的weather存入缓存
//                            weather.getForecasts().get(0).save();
                            SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(WeatherActivity.this).edit();
...
//                            Log.d(TAG, "run: " + responseText);
    ...
    private void showWeatherInfo(Weather weather){
        ...
        for (CastsBean castsBean : weather.getForecasts().get(0).getCasts()){
